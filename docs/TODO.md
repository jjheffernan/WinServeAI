...
**Source:** [readiness/README.md](readiness/README.md) · **Project maturity:** **3.0/5** (`mvp-partial`)  
...
| --- | --- | --- | --- |
| P0 | operator | — | **A2** smoke on Windows: `start` → `GET /v1/models` with **b9866** + GGUF |
...
| P2 | `bin` | 1.8 scaffold | Optional fetch script for **b9866**; `THIRD_PARTY_NOTICES` |
| P2 | `scripts-ops` | 2.8 mvp-partial | Prefer graceful stop over `Stop-Process -Force` when IPC exists |
...
| `docs` | 3.8 mvp-ready | Scorecards + `check_doc_drift.py` |
