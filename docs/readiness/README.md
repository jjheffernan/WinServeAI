...
| installer | 3.0/5 | mvp-partial | No ISCC CI; F4 notices polish + F5 first-run open | [installer.md](./installer.md) |
...
| ui | 3.6/5 | mvp-ready | No system-tray icon yet; Windows quit proof open | [ui.md](./ui.md) |
